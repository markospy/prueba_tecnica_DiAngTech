...
def get_use_cases_user(session: Session = Depends(get_session)) -> UseCasesUser:
...
def create_user(
    ...
    return use_cases_user.create_user(user)
...
def get_user(
    ...
    return use_cases_user.get_user(id)
...
def update_user(
    ...
    return use_cases_user.update_user(id, user)
